...
s1.add(s2) #Print the sum of s1 and s2
s1.sub(s2) #Print the difference of s1 and s2
s1.mul(s2) #Print the product of s1 and s2
s1.div(s2) #Print the division of s1 and s2
